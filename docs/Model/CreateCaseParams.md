...
**rental_origin_location** | **string** | For RENTING_VEHICLE typology. Origin location for vehicle rental. | [optional]
**rental_destination_location** | **string** | For RENTING_VEHICLE typology. Destination location for vehicle rental. | [optional]
**rental_pickup_date** | **\DateTime** | For RENTING_VEHICLE typology. Rental pickup date in UTC and ISO 8601 format. | [optional]
**rental_delivery_date** | **\DateTime** | For RENTING_VEHICLE typology. Rental delivery date in UTC and ISO 8601 format. | [optional]
**private_owner_rental** | **bool** | For RENTING_VEHICLE typology. Flag that indicates if the customer is the rental owner. | [optional]
**rental_owner_name** | **string** | For RENTING_VEHICLE typology. Name of the rental owner/company. | [optional]
**rental_currency** | **string** | For RENTING_VEHICLE typology. Currency for rental amounts. | [optional]
**rental_amount** | [**\Kloutit\Model\Amount**](Amount.md) | For RENTING_VEHICLE typology. Base rental amount. | [optional]
**extra_distance_amount** | [**\Kloutit\Model\Amount**](Amount.md) | For RENTING_VEHICLE typology. Extra distance charge amount. | [optional]
**penalty_amount** | [**\Kloutit\Model\Amount**](Amount.md) | For RENTING_VEHICLE typology. Penalty amount for rental violations. | [optional]
**deposit_amount** | [**\Kloutit\Model\Amount**](Amount.md) | For RENTING_VEHICLE typology. Security deposit amount. | [optional]
**damages_amount** | [**\Kloutit\Model\Amount**](Amount.md) | For RENTING_VEHICLE typology. Damages amount charged to customer. | [optional]
**product_brand** | **string** | For RENTING_VEHICLE typology. Model of the rented vehicle. | [optional]
**product_id** | **string** | Product identifier. If RENTING_VEHICLE typology, this is the vehicle plate number. | [optional]
**tracking_number** | **string** | Tracking number related to the shipment of the product. | [optional]
