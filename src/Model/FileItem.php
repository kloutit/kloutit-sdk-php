...
class FileItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const CATEGORY_BUYER_IDENTITY_PROOF = 'BUYER_IDENTITY_PROOF';
    public const CATEGORY_PRODUCT_EVIDENCE_BEFORE_DURING_PURCHASE = 'PRODUCT_EVIDENCE_BEFORE_DURING_PURCHASE';
    public const CATEGORY_CANCELLATION_REQUEST = 'CANCELLATION_REQUEST';
    public const CATEGORY_REFUND_PROOF = 'REFUND_PROOF';
    public const CATEGORY_TERMS_AND_CONDITIONS_ACCEPTED_PROOF = 'TERMS_AND_CONDITIONS_ACCEPTED_PROOF';
    public const CATEGORY_DUPLICATE_PAYMENT_RECORDS = 'DUPLICATE_PAYMENT_RECORDS';
    public const CATEGORY_DEVICE_DATA_AND_IP_ADDRESSES = 'DEVICE_DATA_AND_IP_ADDRESSES';
    public const CATEGORY_PRODUCT_IMAGE = 'PRODUCT_IMAGE';
    public const CATEGORY_ORDER_HISTORY_AND_TRANSACTIONS = 'ORDER_HISTORY_AND_TRANSACTIONS';
    public const CATEGORY_USAGE_PROOF = 'USAGE_PROOF';
    public const CATEGORY_SHIPPING_AND_DELIVERY_CONFIRMATION = 'SHIPPING_AND_DELIVERY_CONFIRMATION';
    public const CATEGORY_RECURRING_CONSENT_PROOF = 'RECURRING_CONSENT_PROOF';
    ...
    public function getCategoryAllowableValues()
    {
        return [
            ...
            self::CATEGORY_BUYER_IDENTITY_PROOF,
            self::CATEGORY_PRODUCT_EVIDENCE_BEFORE_DURING_PURCHASE,
            self::CATEGORY_CANCELLATION_REQUEST,
            self::CATEGORY_REFUND_PROOF,
            self::CATEGORY_TERMS_AND_CONDITIONS_ACCEPTED_PROOF,
            self::CATEGORY_DUPLICATE_PAYMENT_RECORDS,
            self::CATEGORY_DEVICE_DATA_AND_IP_ADDRESSES,
            self::CATEGORY_PRODUCT_IMAGE,
            self::CATEGORY_ORDER_HISTORY_AND_TRANSACTIONS,
            self::CATEGORY_USAGE_PROOF,
            self::CATEGORY_SHIPPING_AND_DELIVERY_CONFIRMATION,
            self::CATEGORY_RECURRING_CONSENT_PROOF,
