...
/**
 * ClientWebhookEventDto Class Doc Comment
 *
 * @category Class
 * @package  Kloutit
 * @author   OpenAPI Generator team
 ...
 */
class ClientWebhookEventDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ClientWebhookEventDto';
    ...
    */
     ...
     * Sets event_type
     *
     * @param string $event_type The type of the webhook event
     *
     * @return self
     */
     ...
     *
     * @param string $expedient_number The expedient number of the case that the webhook event is related to
     *
     * @return self
     */
