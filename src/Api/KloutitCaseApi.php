...
class KloutitCaseApi
{
    ...
    /**
     * Operation downloadCaseDefense
     *
     * Download the case defense
     *
     * @param  string $expedient_number Case expedient number (required)
     * @param  string $format Format parameter (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['downloadCaseDefense'] to see the possible values for this operation
     *
     * @throws \Kloutit\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function downloadCaseDefense($expedient_number, $format, string $contentType = self::contentTypes['downloadCaseDefense'][0])
    {
        $this->downloadCaseDefenseWithHttpInfo($expedient_number, $format, $contentType);
    }

    /**
     * Operation downloadCaseDefenseWithHttpInfo
     *
     * Download the case defense
     *
     * @param  string $expedient_number Case expedient number (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function downloadCaseDefenseWithHttpInfo($expedient_number, $format, string $contentType = self::contentTypes['downloadCaseDefense'][0])
    {
        $request = $this->downloadCaseDefenseRequest($expedient_number, $format, $contentType);
    ...
    /**
     * Operation downloadCaseDefenseAsync
     *
     * Download the case defense
     *
     * @param  string $expedient_number Case expedient number (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function downloadCaseDefenseAsync($expedient_number, $format, string $contentType = self::contentTypes['downloadCaseDefense'][0])
    {
        return $this->downloadCaseDefenseAsyncWithHttpInfo($expedient_number, $format, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation downloadCaseDefenseAsyncWithHttpInfo
     *
     * Download the case defense
     *
     * @param  string $expedient_number Case expedient number (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function downloadCaseDefenseAsyncWithHttpInfo($expedient_number, $format, string $contentType = self::contentTypes['downloadCaseDefense'][0])
    {
        $returnType = '';
        $request = $this->downloadCaseDefenseRequest($expedient_number, $format, $contentType);
    ...
    /**
     * Create request for operation 'downloadCaseDefense'
     *
     * @param  string $expedient_number Case expedient number (required)
     * @param  string $format Format parameter (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['downloadCaseDefense'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function downloadCaseDefenseRequest($expedient_number, $format, string $contentType = self::contentTypes['downloadCaseDefense'][0])
    {

        // verify the required parameter 'expedient_number' is set
        if ($expedient_number === null || (is_array($expedient_number) && count($expedient_number) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $expedient_number when calling downloadCaseDefense'
            );
        }
        ...
        if ($format === null || (is_array($format) && count($format) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $format when calling downloadCaseDefense'
            );
        }


        $resourcePath = '/case/download-defense/{format}/{expedientNumber}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     */
    public function uploadFile($expedient_number, $file, $category, string $contentType = self::contentTypes['uploadFile'][0])
    {
        list($response) = $this->uploadFileWithHttpInfo($expedient_number, $file, $category, $contentType);
        return $response;
    }
     ...
     */
    public function uploadFileWithHttpInfo($expedient_number, $file, $category, string $contentType = self::contentTypes['uploadFile'][0])
    {
        $request = $this->uploadFileRequest($expedient_number, $file, $category, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadFileAsync($expedient_number, $file, $category, string $contentType = self::contentTypes['uploadFile'][0])
    {
        return $this->uploadFileAsyncWithHttpInfo($expedient_number, $file, $category, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadFileAsyncWithHttpInfo($expedient_number, $file, $category, string $contentType = self::contentTypes['uploadFile'][0])
    {
        $returnType = '\Kloutit\Model\FileItem';
        $request = $this->uploadFileRequest($expedient_number, $file, $category, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function uploadFileRequest($expedient_number, $file, $category, string $contentType = self::contentTypes['uploadFile'][0])
    {
        ...
        if ($category === null || (is_array($category) && count($category) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $category when calling uploadFile'
            );
        }
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['uploadProductPhoto'] to see the possible values for this operation
     *
     * @throws \Kloutit\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Kloutit\Model\FileItem
     */
    public function uploadProductPhoto($expedient_number, $file, string $contentType = self::contentTypes['uploadProductPhoto'][0])
    {
        list($response) = $this->uploadProductPhotoWithHttpInfo($expedient_number, $file, $contentType);
        return $response;
    }

    /**
     * Operation uploadProductPhotoWithHttpInfo
     *
     * Upload product photo
     *
     * @param  string $expedient_number (required)
     ...
     * @return array of \Kloutit\Model\FileItem, HTTP status code, HTTP response headers (array of strings)
     */
    public function uploadProductPhotoWithHttpInfo($expedient_number, $file, string $contentType = self::contentTypes['uploadProductPhoto'][0])
    {
        $request = $this->uploadProductPhotoRequest($expedient_number, $file, $contentType);
    ...
    /**
     * Operation uploadProductPhotoAsync
     *
     * Upload product photo
     *
     * @param  string $expedient_number (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadProductPhotoAsync($expedient_number, $file, string $contentType = self::contentTypes['uploadProductPhoto'][0])
    {
        return $this->uploadProductPhotoAsyncWithHttpInfo($expedient_number, $file, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation uploadProductPhotoAsyncWithHttpInfo
     *
     * Upload product photo
     *
     * @param  string $expedient_number (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadProductPhotoAsyncWithHttpInfo($expedient_number, $file, string $contentType = self::contentTypes['uploadProductPhoto'][0])
    {
        $returnType = '\Kloutit\Model\FileItem';
        $request = $this->uploadProductPhotoRequest($expedient_number, $file, $contentType);
    ...
    /**
     * Create request for operation 'uploadProductPhoto'
     *
     * @param  string $expedient_number (required)
     * @param  \SplFileObject $file A file to upload. Make sure that the specifications follow RFC 2388, which defines file transfers for the multipart/form-data protocol. Allowed formats are &#x60;&#x60;JPG&#x60;&#x60;, &#x60;&#x60;JPEG&#x60;&#x60;, &#x60;&#x60;PNG&#x60;&#x60;. Max. file size is &#x60;&#x60;10Mb&#x60;&#x60;. Ensure that the file upload adheres to [RFC 2388](https://www.ietf.org/rfc/rfc2388.txt), which defines file transfers for the multipart/form-data protocol. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['uploadProductPhoto'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function uploadProductPhotoRequest($expedient_number, $file, string $contentType = self::contentTypes['uploadProductPhoto'][0])
    {

        // verify the required parameter 'expedient_number' is set
        if ($expedient_number === null || (is_array($expedient_number) && count($expedient_number) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $expedient_number when calling uploadProductPhoto'
            );
        }
        ...
        if ($file === null || (is_array($file) && count($file) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $file when calling uploadProductPhoto'
            );
        }


        $resourcePath = '/case/{expedientNumber}/upload-product-photo';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
