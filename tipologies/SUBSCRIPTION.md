### Sample body for Subscription sector

This is a sample UpdateCaseParams for Subscription sector with all the parameters it admits.
...
$kloutitCase = new UpdateCaseParams([
    'sector' => CaseSector::SUBSCRIPTION,
