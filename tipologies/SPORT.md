### Sample body for Sport sector

This is a sample KloutitCaseBody for Sport sector with all the parameters it admits.
...
$kloutitCaseBody = new KloutitCaseBody([
    ...
    'organization_type' => KloutitOrganizationType::SPORT,
