### Sample body for Supply sector

This is a sample KloutitCaseBody for Supply sector with all the parameters it admits.
...
$kloutitCaseBody = new KloutitCaseBody([
    ...
    'organization_type' => KloutitOrganizationType.SUPPLY,
